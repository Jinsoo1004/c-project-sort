...
int main() {
    ...
    switch (input) {
        case 1:
            printf("ผฑลรมคทฤภป ผฑลรวฯผฬฝภดฯดู\n");
            int value[25];
        ...
        case 2:
            printf("ป๐ภิมคทฤภป ผฑลรวฯผฬฝภดฯดู\n");
            int i;
            int list[25];
...
//            int list[25] = {8, 5, 6, 2, 4, 5, 23, 3,32 ,35,235,235, 25,53,2,243, 5,62,3235, 523,2,23 ,5,8,5};
        ...
        case 3:
            printf("น๖บํมคทฤภป ผฑลรวฯผฬฝภดฯดู.");
            int array[25];
            printf("\n");
            printf("ปýผบตศ ทฃดýฐช : ");
            for (int i = 0; i < 25; i++) { // 25น๘ นÝบน
        ...
        case 4:
            printf("ฤüมคทฤภป ผฑลรวฯผฬฝภดฯดู.");
            int data[25];
            printf("\n");
            printf("ปýผบตศ ทฃดýฐช : ");
            for (int i = 0; i < 25; i++) { // 25น๘ นÝบน
        ...
        case 5:
            printf("วีบดมคทฤภป ผฑลรวฯผฬฝภดฯดู.");
            printf("\n");
            int marray[25];
            printf("ปýผบตศ ทฃดýฐช : ");
            for (int i = 0; i < 25; i++) { // 25น๘ นÝบน
